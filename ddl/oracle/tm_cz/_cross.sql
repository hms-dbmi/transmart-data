...
--
--CREATE INDEX "TM_CZ"."IDX_I2B2_SECURE_FULLNAME" ON "I2B2METADATA"."I2B2_SECURE" ("C_FULLNAME") TABLESPACE "TRANSMART" ;

--
-- Type: INDEX; Owner: TM_CZ; Name: IX_I2B2_SOURCE_SYSTEM_CD
--
--CREATE INDEX "TM_CZ"."IX_I2B2_SOURCE_SYSTEM_CD" ON "I2B2METADATA"."I2B2" ("SOURCESYSTEM_CD") TABLESPACE "TRANSMART" ;

--
-- Type: INDEX; Owner: TM_CZ; Name: IX_DE_SUBJECT_SMPL_MPNG_MRNA
--
--CREATE INDEX "TM_CZ"."IX_DE_SUBJECT_SMPL_MPNG_MRNA" ON "DEAPP"."DE_SUBJECT_SAMPLE_MAPPING" ("TRIAL_NAME", "PLATFORM", "SOURCE_CD", "CONCEPT_CODE") TABLESPACE "TRANSMART" ;
